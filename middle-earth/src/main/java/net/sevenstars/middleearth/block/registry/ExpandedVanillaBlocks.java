...
public class ExpandedVanillaBlocks {
    ...
    // region COPPER BARS
    public static final Block COPPER_BARS = YelfraBlockRegistration.registerBlock(
            "copper_bars",
    ...
    public static final Block EXPOSED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
            "exposed_copper_bars",
            ...
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WEATHERED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
            ...
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block OXIDIZED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
    ...
    public static final Block WAXED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
            "waxed_copper_bars",
            PaneBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_EXPOSED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
            "waxed_exposed_copper_bars",
            PaneBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_WEATHERED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
            "waxed_weathered_copper_bars",
            PaneBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_OXIDIZED_COPPER_BARS = YelfraBlockRegistration.registerBlock(
    ...
    public static final Block CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "cut_copper_wall",
            (settings) -> new OxidizableWallBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
            AbstractBlock.Settings.copy(Blocks.CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block EXPOSED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "exposed_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
            AbstractBlock.Settings.copy(Blocks.EXPOSED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WEATHERED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "weathered_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(Oxidizable.OxidationLevel.WEATHERED, settings),
            AbstractBlock.Settings.copy(Blocks.WEATHERED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block OXIDIZED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "oxidized_cut_copper_wall",
            (settings) -> new OxidizableWallBlock(Oxidizable.OxidationLevel.OXIDIZED, settings),
            AbstractBlock.Settings.copy(Blocks.OXIDIZED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "waxed_cut_copper_wall",
            WallBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_EXPOSED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "waxed_exposed_cut_copper_wall",
            WallBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_WEATHERED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
            "waxed_weathered_cut_copper_wall",
            WallBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_OXIDIZED_CUT_COPPER_WALL = YelfraBlockRegistration.registerBlock(
    ...
    public static final Block CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
            AbstractBlock.Settings.copy(Blocks.CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block EXPOSED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "exposed_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
            AbstractBlock.Settings.copy(Blocks.EXPOSED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WEATHERED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "weathered_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(Oxidizable.OxidationLevel.WEATHERED, settings),
            AbstractBlock.Settings.copy(Blocks.WEATHERED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block OXIDIZED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "oxidized_cut_copper_vertical_slab",
            (settings) -> new OxidizableVerticalSlabBlock(Oxidizable.OxidationLevel.OXIDIZED, settings),
            AbstractBlock.Settings.copy(Blocks.OXIDIZED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "waxed_cut_copper_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_EXPOSED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "waxed_exposed_cut_copper_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_WEATHERED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "waxed_weathered_cut_copper_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block WAXED_OXIDIZED_CUT_COPPER_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
    ...
    public static final Block DIRT_SLAB = YelfraBlockRegistration.registerBlock(
            "dirt_slab",
            SlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block COARSE_DIRT_SLAB = YelfraBlockRegistration.registerBlock(
            "coarse_dirt_slab",
            SlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.COARSE_DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block ROOTED_DIRT_SLAB = YelfraBlockRegistration.registerBlock(
            "rooted_dirt_slab",
            SlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.ROOTED_DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block MUD_SLAB = YelfraBlockRegistration.registerBlock(
            "mud_slab",
            SlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.MUD),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block MOSS_SLAB = YelfraBlockRegistration.registerBlock(
            "moss_slab",
            SlabBlock::new,
    ...
    public static final Block DIRT_STAIRS = YelfraBlockRegistration.registerBlock(
            "dirt_stairs",
            (settings) -> new StairsBlock(Blocks.DIRT.getDefaultState(), settings),
            AbstractBlock.Settings.copy(Blocks.DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block COARSE_DIRT_STAIRS = YelfraBlockRegistration.registerBlock(
            "coarse_dirt_stairs",
            (settings) -> new StairsBlock(Blocks.COARSE_DIRT.getDefaultState(), settings),
            AbstractBlock.Settings.copy(Blocks.COARSE_DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block ROOTED_DIRT_STAIRS = YelfraBlockRegistration.registerBlock(
            "rooted_dirt_stairs",
            (settings) -> new StairsBlock(Blocks.ROOTED_DIRT.getDefaultState(), settings),
            AbstractBlock.Settings.copy(Blocks.ROOTED_DIRT),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block MUD_STAIRS = YelfraBlockRegistration.registerBlock(
            "mud_stairs",
            ...
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block MOSS_STAIRS = YelfraBlockRegistration.registerBlock(
            "moss_stairs",
    ...
    public static final Block BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block MUD_BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "mud_brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.MUD_BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block SMOOTH_SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "smooth_sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.SMOOTH_SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block CUT_SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "cut_sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.CUT_SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block RED_SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "red_sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.RED_SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block SMOOTH_RED_SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "smooth_red_sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.SMOOTH_RED_SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block CUT_RED_SANDSTONE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "cut_red_sandstone_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.CUT_RED_SANDSTONE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block PRISMARINE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "prismarine_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.PRISMARINE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block PRISMARINE_BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "prismarine_brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.PRISMARINE_BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block DARK_PRISMARINE_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "dark_prismarine_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.DARK_PRISMARINE_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block NETHER_BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "nether_brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.NETHER_BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block RED_NETHER_BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "red_nether_brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.RED_NETHER_BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block END_STONE_BRICK_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "end_stone_brick_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.END_STONE_BRICK_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block PURPUR_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "purpur_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.PURPUR_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block QUARTZ_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
            "quartz_vertical_slab",
            VerticalSlabBlock::new,
            AbstractBlock.Settings.copy(Blocks.QUARTZ_SLAB),
            ItemGroupsME.STONE_BLOCKS_CONTENTS);
    public static final Block SMOOTH_QUARTZ_VERTICAL_SLAB = YelfraBlockRegistration.registerBlock(
    ...
    public static final Block GRAVEL_LAYER = YelfraBlockRegistration.registerBlock(
            "gravel_layer",
            (settings) -> new LayersBlock(settings, Blocks.GRAVEL),
            AbstractBlock.Settings.copy(Blocks.GRAVEL),
            ItemGroupsME.MISC_BLOCKS_CONTENTS);
    public static final Block SAND_LAYER = YelfraBlockRegistration.registerBlock(
            "sand_layer",
